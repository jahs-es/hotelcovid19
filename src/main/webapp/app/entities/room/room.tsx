...
export type IRoomState = IPaginationBaseState;
...
export class Room extends React.Component<IRoomProps, IRoomState> {
  ...
  render() {
    ...
    return (
      <div>
        <h2 id="room-heading">
          <Translate contentKey="hotelcovid19App.room.home.title">Rooms</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="hotelcovid19App.room.home.createLabel">Create a new Room</Translate>
          </Link>
        </h2>
          ...
          >
            {roomList && roomList.length > 0 ? (
                ...
                <thead>
                  <tr>
                    ...
                    <th className="hand" onClick={this.sort('name')}>
                      <Translate contentKey="hotelcovid19App.room.name">Name</Translate> <FontAwesomeIcon icon="sort" />
                    </th>
                    <th>
                      <Translate contentKey="hotelcovid19App.room.user">User</Translate> <FontAwesomeIcon icon="sort" />
                    </th>
                    <th />
                  </tr>
                </thead>
              ...
              <div className="alert alert-warning">
                <Translate contentKey="hotelcovid19App.room.home.notFound">No Rooms found</Translate>
              </div>
            )}
          </InfiniteScroll>
        </div>
